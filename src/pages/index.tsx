...
export default function Home({ posts }: { posts: Post[] }) {
  ...
  return (
    <>
      <h1 className="text-2xl sm:text-3xl font-bold text-slate-900 tracking-tight mb-3 text-center">Hello there!</h1>
      <p className="text-slate-700 text-center">Welcome to my blog</p>
      <p className="text-slate-700 text-center">I share anything from System Administration to Development posts here</p>
      <hr className="my-5" />
