...
---
## Creating a Runbook
<Image alt="Hello" src="/creating-runbook/runbook.jpg" />
...
A runbook should contain regularly executed tasks, complex instructions for regular to non-regular occuring issues, or even easily forgotten details pertaining to certain processes with systems/applications.

An example of this is:
- A new onboarded employee needs to become familar with a certain client's new user set up, which could be a large process, but if they have a checklist through the runbook. They could go through it sequentially and become familar with that particular environment much faster.
